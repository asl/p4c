...
class DiscoverStructure : public InspectorCRTP<DiscoverStructure> {
 ...
 public:
    ...
    void postorder(const IR::ParameterList *paramList);
    void postorder(const IR::P4Action *action);
    void postorder(const IR::Declaration_Variable *decl);
    void postorder(const IR::Type_Error *errors);
    void postorder(const IR::Declaration_MatchKind *kind);
};
...
class BuildResourceMap : public InspectorCRTP<BuildResourceMap> {
    using Base = InspectorCRTP<BuildResourceMap>;
    ResourceMap *resourceMap;
 ...
 public:
    ...
    using Base::preorder;
    bool preorder(const IR::ControlBlock *control) {
    ...
    bool preorder(const IR::ParserBlock *parser) {
    ...
    bool preorder(const IR::TableBlock *table) {
